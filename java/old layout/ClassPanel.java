...
class ClassPanel extends JPanel implements ActionListener {
	...
	//	alignBox.add(alignmentBox);
		...
		if(classString.equals("Berserker")) {
			skills[1][1] = new SkillBox("Group Skill: Increase combo meter growth rate",11);
			...
			skills[1][1] = new SkillBox("Group Skill: Increase health regen over time",.1,Color.cyan,8);
			...
			skills[5][1] = new SkillBox("Group Skill: Increase max hit points",1);
			...
			skills[1][1] = new SkillBox("Group Skill: Increase chance of critical strike",.5);
			...
			skills[1][1] = new SkillBox("Group Skill: Increase secondary fire power",2.5);
			...
			skills[1][1] = new SkillBox("Group Skill: Decrease damage taken",.5);
