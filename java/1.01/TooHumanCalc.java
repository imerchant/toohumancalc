...
public class TooHumanCalc extends JFrame implements ActionListener, java.io.Serializable {
	...
	private Icons icons;
	private static final String version = "v1.1alpha";
	...
	//	topBox.add(classBox);
		...
		Box profileBox = /*Box.createHorizontalBox();//*/Box.createVerticalBox();
	...
	//	profileBox.add(new JScrollPane(classdesc));
		...
		JPanel classLabels = new JPanel(new GridLayout(5,0));
		JPanel classBars = new JPanel(new GridLayout(5,0));
		...
		classLabels.add(new JLabel("SPECIALIZATION  "));
	...
	/*	hitBar.setStringPainted(true);
		...
		Box pClass = /*Box.createHorizontalBox();//*/Box.createVerticalBox();
	...
	//	pClass.add(new JScrollPane(classdesc));
	...
	//	Box descBox = Box.createHorizontalBox();//Box.createVerticalBox();
	//	descBox.add(pClass);
	...
	//	profileBox.add(descBox);
		...
		profileBox.add(pClass);
	//	profileBox.add(new JScrollPane(aligndesc));
	...
	private void setClassDescText(String name) {
		if(name == null) {
			...
			armorBar.setValue(3);
			specLabel.setText("Damage dealing, Dual Wield Weapons");
			classdesc.setText("The Berserker delights in the fury of close quarters combat, forgoing defensive "+
			...
			armorBar.setValue(3);
			specLabel.setText("Regeneration, Healing");
			...
			armorBar.setValue(3);
			specLabel.setText("Air Combat, Critical Strikes");
			...
			armorBar.setValue(3);
			specLabel.setText("Explosives Master, Spider Master");
			...
			ballisticsBar.setValue(2);
			armorBar.setValue(4);
			specLabel.setText("Defensive toughness, Hammer & Shield");
