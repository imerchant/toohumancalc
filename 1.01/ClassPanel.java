...
//	private JComboBox alignmentBox;
	...
	public ClassPanel() {}
	public ClassPanel(String classS) { this(classS,null,new Icons()); }
	...
	//	add(topPanel,BorderLayout.WEST);
		...
		skills[0][2] = new SkillBox(icons.get("unknown"),"Human Ruiner","Increases Ruiner radius and damage.",
		...
		if(classString.equals("Berserker")) {
			...
			skills[1][1] = new SkillBox(icons.get("champion1"),"Unerring Strike","Increases chance of critical strikes.",
			...
			skills[6][2] = new SkillBox(icons.get("champion12"),"Stopping Power","Increases Slug ammunition damage.",null,4,10,Color.cyan);
			
			off = 1;
		} else if(classString.equals("Commando")) {
			skills[1][1] = new SkillBox(icons.get("unknown"),"Wreaker of Mead Halls (Group Skill)","Increases damage and radius of all",
				"secondary fire.",2.5,10,Color.green);
			
			skills[2][0] = new SkillBox(icons.get("unknown"),"Pinning Shot","Increases chance that Ballisitc shots will",
			...
			skills[2][1] = new SkillBox(icons.get("unknown"),"Rain of Iron","Increases Slug ammunition rate of fire.",
				null,3,10,Color.cyan);
			...
			skills[4][1] = new SkillBox(icons.get("unknown"),"Lightning Crusade","Battle Cry: Attacks will include delayed detionation",
			...
			skills[2][2] = new SkillBox(icons.get("unknown"),"Adept of Burning Spear","Increases Plasma ammunition damage.",
				null,3,10,Color.cyan);
			...
			skills[1][1] = new SkillBox(icons.get("defender1"),"Defender's Resilience","Decreases the amount of damage taken.",
				null,.5,10,Color.green);
